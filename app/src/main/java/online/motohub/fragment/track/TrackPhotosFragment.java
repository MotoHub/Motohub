...
public class TrackPhotosFragment extends BaseFragment {

    @BindView(R.id.rv_photos_track)
    RecyclerView mGalleryRv;
    @BindView(R.id.txt_no_data_track)
    TextView txtNoData;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_track_photos, container, false);
    }
    ...
    private void getGalleryImages() {
        String mFilter = "(UserID=" + mPromotersResModel.getUserId() + ") AND (" + APIConstants.UserType + "=track)";
