...
import online.motohub.newdesign.constants.ModelConstants;
import online.motohub.tags.AdapterTag;
import online.motohub.util.UrlUtils;
import online.motohub.util.Utility;

public class BusinessNewsFeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    private PromotersResModel businessProfile;
    private int adapPos;
...
//        }
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        void setClickListener() {
            ...
            sharedUserImg.setOnClickListener(BusinessNewsFeedAdapter.this);
            sharedProfileNameTxt.setTag(tag);
            sharedProfileNameTxt.setOnClickListener(BusinessNewsFeedAdapter.this);
            sharedPostTimeTxt.setTag(tag);
            sharedPostTimeTxt.setOnClickListener(BusinessNewsFeedAdapter.this);
            sharedNotifyIcon.setTag(tag);
            sharedNotifyIcon.setOnClickListener(BusinessNewsFeedAdapter.this);
            sharedDownIcon.setTag(tag);
            sharedDownIcon.setOnClickListener(BusinessNewsFeedAdapter.this);

            userImg.setTag(tag);
            userImg.setOnClickListener(BusinessNewsFeedAdapter.this);
            profileNameTxt.setTag(tag);
            profileNameTxt.setOnClickListener(BusinessNewsFeedAdapter.this);
            postTimeTxt.setTag(tag);
            postTimeTxt.setOnClickListener(BusinessNewsFeedAdapter.this);
            notifyIcon.setTag(tag);
            notifyIcon.setOnClickListener(BusinessNewsFeedAdapter.this);
            downIcon.setTag(tag);
            downIcon.setOnClickListener(BusinessNewsFeedAdapter.this);

            imgVideoView.setTag(tag);
            imgVideoView.setOnClickListener(BusinessNewsFeedAdapter.this);

            commentView.setTag(tag);
            commentView.setOnClickListener(BusinessNewsFeedAdapter.this);
...
//            shareCountTxt.setOnClickListener(NewsFeedAdapter.this);
            ...
            commentsCountTxt.setOnClickListener(BusinessNewsFeedAdapter.this);

            likeBtn.setTag(tag);
            likeBtn.setOnClickListener(BusinessNewsFeedAdapter.this);
            commentBtn.setTag(tag);
            commentBtn.setOnClickListener(BusinessNewsFeedAdapter.this);
            shareBtn.setTag(tag);
            shareBtn.setOnClickListener(BusinessNewsFeedAdapter.this);
        }
    }
