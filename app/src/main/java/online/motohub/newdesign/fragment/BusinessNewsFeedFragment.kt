...
import kotlinx.android.synthetic.main.fragment_business_news_feed.*
...
import online.motohub.newdesign.adapter.BusinessNewsFeedAdapter
import online.motohub.newdesign.constants.AppConstants
import online.motohub.newdesign.viewmodel.BaseViewModelFactory
import online.motohub.newdesign.viewmodel.BusinessNewsFeedViewModel
...
class BusinessNewsFeedFragment : BaseFragment(), androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener, AdapterClickCallBack {


    private var model: BusinessNewsFeedViewModel? = null
    private var feedAdapter: BusinessNewsFeedAdapter? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_business_news_feed, container, false)
    }
