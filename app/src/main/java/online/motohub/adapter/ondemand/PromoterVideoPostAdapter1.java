...
public class PromoterVideoPostAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PromoterVideoPostAdapter1(List<PromoterVideoModel.Resource> postsList, ProfileResModel mMyProfileResModel, Context ctx, int ProfileID, PromoterOrUserFragment promoterOrUserFragment) {
                        ...
                        public void onClick(View view) {
                            ...
                            if (mMyFollowingsID != null) {
                                ...
                                if (isVideoFile) {
                                    ...
                                    promoterOrUserFragment.showBottomSheetDialog(content, null, mVideosList, position, true);
