...
public class ChatBoxGroupMsgAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChatBoxGroupMsgAdapter(ArrayList<GroupChatMsgResModel> grpChatMsgList, Context ctx) {
        ...
        switch (getItemViewType(position)) {
            ...
            case SENDER:
                ...
                mViewHolderSender.ivCommentImg.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((BaseActivity) mContext).moveLoadImageScreen(mContext, mGrpChatMsgList.get(position).getPhotoMessage());
