...
public class NotificationUpdateProfileActivity extends BaseActivity {
    ...
    private void setMotoProfileVal() {
        ...
        if (mMyProfileResModel.getDriver() != null)
            mDriverOrNameEt.setText(mMyProfileResModel.getDriver());
        else
            mDriverOrNameEt.setVisibility(View.GONE);

        if (mMyProfileResModel.getMotoName() != null)
            mNameOfMotoEt.setText(mMyProfileResModel.getMotoName());
        else
            mNameOfMotoEt.setVisibility(View.GONE);

        if (mMyProfileResModel.getMake() != null)
            mMakeEt.setText(mMyProfileResModel.getMake());
        else
            mMakeEt.setVisibility(View.GONE);

        if (mMyProfileResModel.getModel() != null)
            mModelEt.setText(mMyProfileResModel.getModel());
        else
            mModelEt.setVisibility(View.GONE);

        if (mMyProfileResModel.getHP() != 0)
            mPhoneEt.setText(mMyProfileResModel.getPhone());
        else
        ...
        if (mMyProfileResModel.getHP() != 0)
            ...
            mHPEt.setVisibility(View.GONE);

        if (mMyProfileResModel.getEngineSpecs() != null)
            mEngineSpecsEt.setText(mMyProfileResModel.getEngineSpecs());
        else
            mEngineSpecsEt.setVisibility(View.GONE);

        if (mMyProfileResModel.getPanelPaint() != null)
            mPanelAndPaintEt.setText(mMyProfileResModel.getPanelPaint());
        else
            mPanelAndPaintEt.setVisibility(View.GONE);

        if (!String.valueOf(mMyProfileResModel.getProfileType()).equals(BOAT)) {
            if (mMyProfileResModel.getWheelsTyres() != null)
                mWheelsAndTiresEt.setText(mMyProfileResModel.getWheelsTyres());
            else
                mWheelsAndTiresEt.setVisibility(View.GONE);
        }

        if (String.valueOf(mMyProfileResModel.getProfileType()).equals(CAR)) {

            if (mMyProfileResModel.getECU() != null)
                mEcuEt.setText(mMyProfileResModel.getECU());
            else
                mEcuEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getGearBox() != null)
                mGearEt.setText(mMyProfileResModel.getGearBox());
            else
                mGearEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getDifferencial() != null)
                mDifferentialEt.setText(mMyProfileResModel.getDifferencial());
            else
                mDifferentialEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getClutch() != null)
                mClutchEt.setText(mMyProfileResModel.getClutch());
            else
                mClutchEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getInjection() != null)
                mInjectionEt.setText(mMyProfileResModel.getInjection());
            else
                mInjectionEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getFuelSystem() != null)
                mFuelEt.setText(mMyProfileResModel.getFuelSystem());
            else
                mFuelEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getTurbo() != null)
                mTurboEt.setText(mMyProfileResModel.getTurbo());
            else
                mTurboEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getSuspension() != null)
                mSuspensionEt.setText(mMyProfileResModel.getSuspension());
            else
                mSuspensionEt.setVisibility(View.GONE);
        ...
        if (String.valueOf(mMyProfileResModel.getProfileType()).equals(BIKE)) {
            ...
            if (mMyProfileResModel.getTyres() != null)
                mTyresEt.setText(mMyProfileResModel.getTyres());
            else
                mTyresEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getExhaust() != null)
                mExhaustEt.setText(mMyProfileResModel.getExhaust());
            else
                mExhaustEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getForks() != null)
                mForkEt.setText(mMyProfileResModel.getForks());
            else
                mForkEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getShock() != null)
                mShockEt.setText(mMyProfileResModel.getShock());
            else
                mShockEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getLapTimer() != null)
                mLapTimerEt.setText(mMyProfileResModel.getLapTimer());
            else
                mLapTimerEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getRearSets() != null)
                mRearSetEt.setText(mMyProfileResModel.getRearSets());
            else
                mRearSetEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getChain() != null)
                mChainEt.setText(mMyProfileResModel.getChain());
            else
                mChainEt.setVisibility(View.GONE);
            ...
            if (mMyProfileResModel.getFairings() != null)
                mFairingsEt.setText(mMyProfileResModel.getFairings());
            else
                mFairingsEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getSprockets() != null)
                mSprocketsEt.setText(mMyProfileResModel.getSprockets());
            else
                mSprocketsEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getEngineCovers() != null)
                mEngineCoverEt.setText(mMyProfileResModel.getEngineCovers());
            else
                mEngineSpecsEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getBrakeMaster() != null)
                mBrakeMasterEt.setText(mMyProfileResModel.getBrakeMaster());
            else
                mBrakeMasterEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getBrakePad() != null)
                mBrakePadEt.setText(mMyProfileResModel.getBrakePad());
            else
                mBrakePadEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getBrakeFluid() != null)
                mBrakeFluidEt.setText(mMyProfileResModel.getBrakeFluid());
            else
                mBrakeFluidEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getFilter() != null)
                mFilterEt.setText(mMyProfileResModel.getFilter());
            else
                mFilterEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getHandleBars() != null)
                mHandleBarEt.setText(mMyProfileResModel.getHandleBars());
            else
                mHandleBarEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getChainLube() != null)
                mChainLubeEt.setText(mMyProfileResModel.getChainLube());
            else
                mChainLubeEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getEngineOil() != null)
                mEngineOilEt.setText(mMyProfileResModel.getEngineOil());
            else
                mEngineOilEt.setVisibility(View.GONE);
        }

        if (String.valueOf(mMyProfileResModel.getProfileType()).equals(BIKE)
                || (String.valueOf(mMyProfileResModel.getProfileType()).equals(CAR))) {

            if (mMyProfileResModel.getBoots() != null)
                mBootsEt.setText(mMyProfileResModel.getBoots());
            else
                mBootsEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getHelmet() != null)
                mHelmetEt.setText(mMyProfileResModel.getHelmet());
            else
                mHelmetEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getSuit() != null)
                mSuitEt.setText(mMyProfileResModel.getSuit());
            else
                mSuitEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getGloves() != null)
                mGloveEt.setText(mMyProfileResModel.getGloves());
            else
                mGloveEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getBackProtection() != null)
                mBackProtectionEt.setText(mMyProfileResModel.getBackProtection());
            else
                mBackProtectionEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getChestProtection() != null)
                mChestProtectionEt.setText(mMyProfileResModel.getChestProtection());
            else
                mChestProtectionEt.setVisibility(View.GONE);

            if (mMyProfileResModel.getTrailer() != null)
                mTrailerEt.setText(mMyProfileResModel.getTrailer());
            else
                mTrailerEt.setVisibility(View.GONE);

        }

        if (mMyProfileResModel.getMoreInformation() != null)
            mMoreInfoEt.setText(mMyProfileResModel.getMoreInformation());
        else
            mMoreInfoEt.setVisibility(View.GONE);
