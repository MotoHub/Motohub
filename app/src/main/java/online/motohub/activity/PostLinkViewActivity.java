...
public class PostLinkViewActivity extends BaseActivity implements PostViewAdapter.TotalRetrofitPostsResultCount {
    ...
    SharePostInterface mShareTextWithPostInterface = new SharePostInterface() {
        ...
        public void onSuccess(String shareMessage) {
            ...
            CommonAPI.getInstance()
                    .callPostShare(PostLinkViewActivity.this, mPostList.get(mCurrentPostPosition), mCurrentProfileObj.getID());
        }
    };
    ...
    private void initView() {
        ...
        if (action != null) {
            ...
            assert data != null;
            mFilter = "id=" + data.getQueryParameter("PostID");
        }
        getMotoProfiles();
    }
    ...
    private void getMotoProfiles() {
        AsyncTask.execute(() -> {
            ...
            int mUserID = PreferenceUtils.getInstance(PostLinkViewActivity.this).getIntData(PreferenceUtils.USER_ID);
            String mFilter = "UserID = " + mUserID;
            RetrofitClient.getRetrofitInstance().callGetProfiles(PostLinkViewActivity.this, mFilter, RetrofitClient.GET_PROFILE_RESPONSE);
        });
    ...
    private void getPost(final String mFilter) {
        AsyncTask.execute(() -> {
            ...
            if (mCurrentProfileObj != null) {
                ...
                RetrofitClient.getRetrofitInstance().callGetProfilePost(PostLinkViewActivity.this, mFilter, RetrofitClient.GET_FEED_POSTS_RESPONSE, mDataLimit, mPostsRvOffset);
            }
        });
