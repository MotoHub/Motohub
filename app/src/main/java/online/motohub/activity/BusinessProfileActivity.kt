...
import online.motohub.viewmodel.BusinessProfileViewModel
...
class BusinessProfileActivity : BaseActivity(), TabLayout.OnTabSelectedListener, BusinessPostAdapter.TotalRetrofitPostsResultCount {
    ...
    private fun setProfile() {
        ...
        EventBus.getDefault().postSticky(model!!.businessProfileObj)
        val mBusinessHomeFragment = BusinessHomeFragment()
