...
/**
 * Created by pickzy01 on 23/07/2018.
 */
            ...
            if (pos > 0) {
                ...
                if (mOtherProfileID != mMyProfileID) {
                    if (usertype.equals(AppConstants.USER) || usertype.equals(AppConstants.ONDEMAND) || usertype.equals(AppConstants.USER_EVENT_VIDEOS)) {
                        ...
                        RetrofitClient.getRetrofitInstance().callGetIsAlreadyFollowedUserWithoutBuffering(EventVideosPlayingActivity.this, mFollowRelation, RetrofitClient.PROFILE_IS_ALREADY_FOLLOWED);
                    } else {
    ...
    private void callGetProfile(final int mProfileID, final int responseType) {
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                RetrofitClient.getRetrofitInstance().callGetProfilesWithoutBuffering(EventVideosPlayingActivity.this, mFilter, responseType);
            }
        });
    }
    ...
    private void initializePlayer() {
        ...
        mExoPlayer.addListener(new Player.EventListener() {
            ...
            public void onPlayerError(ExoPlaybackException error) {
                ...
                showToast(EventVideosPlayingActivity.this, err);
                if (isNextVideo)
                    manageNextVideoAndPlayer();
                else
                    managePrevVideoAndPlayer();
                ...
                if (pos >= 0) {
                    try {
                        ...
                        if (mIsAlreadyBlocked) {
                            showToast(EventVideosPlayingActivity.this, getString(R.string.follow_err));
                        } else if (isBlockedme) {
                            showToast(EventVideosPlayingActivity.this, getString(R.string.block_follow_err));
                        } else {
                            if (mIsAlreadyFollowing) {
                                if (usertype.equals(AppConstants.USER)
                                    ...
                                    RetrofitClient.getRetrofitInstance()
                                            .callUnFollowProfileWithoutBuffering(EventVideosPlayingActivity.this, mFilter, RetrofitClient.UN_FOLLOW_PROFILE_RESPONSE);
                                } else {
                                    String mFilter = "FollowRelation=" + mMyProfileID + "_" + mOtherProfileID;
                                    RetrofitClient.getRetrofitInstance()
                                            .callUnFollowPromoterWithoutBuffering(EventVideosPlayingActivity.this, mFilter, RetrofitClient.GET_PROMOTER_UN_FOLLOW_RESPONSE);
                                }
                            } else {
                                if (usertype.equals(AppConstants.USER)
                                        || usertype.equals(AppConstants.ONDEMAND)
                                    ...
                                    CommonAPI.getInstance()
                                            .callFollowProfile(EventVideosPlayingActivity.this, mMyProfileID, mOtherProfileID);
                                } else {
                                    CommonAPI.getInstance()
                                            .callFollowPromoter(EventVideosPlayingActivity.this, mOtherProfileID, mMyProfileID);
                                }
                            }
                        }
                    } catch (Exception e) {
