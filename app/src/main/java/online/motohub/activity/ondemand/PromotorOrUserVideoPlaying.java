        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (pos < mPostsList.size() && pos > 0) {
                    ...
                    if (pos < mPostsList.size()) {
                        if (isAlreadyLikedPost()) {
                            mLikeBtn.setBackground(ContextCompat.getDrawable(PromotorOrUserVideoPlaying.this, R.drawable.liked_icon));
                            mLikeBtn.setTag("unlike");
                        } else {
                            mLikeBtn.setBackground(ContextCompat.getDrawable(PromotorOrUserVideoPlaying.this, R.drawable.like_icon));
                            mLikeBtn.setTag("like");
                        }
                        isAlreadyFollowed();
                        playVideo();
