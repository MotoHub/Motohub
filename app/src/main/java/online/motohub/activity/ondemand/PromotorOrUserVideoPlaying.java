...
/**
 * Created by pickzy01 on 13/07/2018.
 */

public class PromotorOrUserVideoPlaying extends BaseActivity {
        ...
        try {
            if (pos >= 0) {
                ...
                if (mOtherProfileID != mMyProfileID) {
                    if (usertype.equals(AppConstants.USER) || usertype.equals(AppConstants.ONDEMAND) || usertype.equals(AppConstants.USER_EVENT_VIDEOS)) {
                        String mFollowRelation = mOtherProfileID + "_" + mMyProfileID;
                        RetrofitClient.getRetrofitInstance().callGetIsAlreadyFollowedUserWithoutBuffering(PromotorOrUserVideoPlaying.this, mFollowRelation, RetrofitClient.PROFILE_IS_ALREADY_FOLLOWED);
                    } else {
                        String mFollowRelation = mMyProfileID + "_" + mOtherProfileID;
                        RetrofitClient.getRetrofitInstance().callGetIsAlreadyFollowedPromoterWithoutBuffering(PromotorOrUserVideoPlaying.this, mFollowRelation, RetrofitClient.PROMOTER_IS_ALREADY_FOLLOWED);
                    }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mIsAlreadyFollowing == true) {
                    ...
                    mFollowBtn.setBackground(ContextCompat.getDrawable(PromotorOrUserVideoPlaying.this, R.drawable.ic_follow));
                } else if (mIsAlreadyFollowing == false) {
                    follow_unfollow_txt.setText("Follow");
                    mFollowBtn.setBackground(ContextCompat.getDrawable(PromotorOrUserVideoPlaying.this, R.drawable.ic_unfollow));
                }
            }
        });
    ...
    private void callGetProfile(final int mProfileID, final int responseType) {
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                RetrofitClient.getRetrofitInstance().callGetProfilesWithoutBuffering(PromotorOrUserVideoPlaying.this, mFilter, responseType);
            }
        });
    }
    ...
    private void setSwipeListenerForVideoView() {
        mVideoView.setOnTouchListener(new OnSwipeTouchListener(PromotorOrUserVideoPlaying.this) {
    ...
    private void initializePlayer() {
        ...
        mExoPlayer.addListener(new ExoPlayer.EventListener() {
            ...
            public void onPlayerError(ExoPlaybackException error) {
                ...
                showToast(PromotorOrUserVideoPlaying.this, "Can't play this video");
                if (isNextVideo)
                    manageNextVideoAndPlayer();
                else
                    managePrevVideoAndPlayer();
            ...
            public void run() {
                ...
                if (pos >= 0) {
                    ...
                    if (mIsAlreadyBlocked) {
                        showToast(PromotorOrUserVideoPlaying.this, getString(R.string.follow_err));
                    } else if (isBlockedme) {
                        showToast(PromotorOrUserVideoPlaying.this, getString(R.string.block_follow_err));
                    } else {
                        if (mIsAlreadyFollowing) {
                            if (usertype.equals(AppConstants.USER)
                                ...
                                RetrofitClient.getRetrofitInstance()
                                        .callUnFollowProfileWithoutBuffering(PromotorOrUserVideoPlaying.this, mFilter, RetrofitClient.UN_FOLLOW_PROFILE_RESPONSE);
                            } else {
                                String mFilter = "FollowRelation=" + mMyProfileID + "_" + mOtherProfileID;
                                RetrofitClient.getRetrofitInstance()
                                        .callUnFollowPromoterWithoutBuffering(PromotorOrUserVideoPlaying.this, mFilter, RetrofitClient.GET_PROMOTER_UN_FOLLOW_RESPONSE);
                            }
                        } else {
                            if (usertype.equals(AppConstants.USER)
                                    || usertype.equals(AppConstants.ONDEMAND)
                                ...
                                CommonAPI.getInstance()
                                        .callFollowProfile(PromotorOrUserVideoPlaying.this, mMyProfileID, mOtherProfileID);
                            } else {
                                CommonAPI.getInstance()
                                        .callFollowPromoter(PromotorOrUserVideoPlaying.this, mOtherProfileID, mMyProfileID);
                            }
                        }
                    }
                }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (pos < mPostsList.size() && pos > 0) {
                    ...
                    if (pos < mPostsList.size()) {
                        if (isAlreadyLikedPost()) {
                            mLikeBtn.setBackground(ContextCompat.getDrawable(PromotorOrUserVideoPlaying.this, R.drawable.like_click_to_like_bg));
                            mLikeBtn.setTag("unlike");
                        } else {
                            mLikeBtn.setBackground(ContextCompat.getDrawable(PromotorOrUserVideoPlaying.this, R.drawable.like_to_like_click_bg));
                            mLikeBtn.setTag("like");
                        }
                        isAlreadyFollowed();
                        playVideo();
        ...
        RetrofitClient.getRetrofitInstance().getRetrofitApiInterface().callGetPromotersVideos(fields, filter, APIConstants.mPromoterGalleryRelated,
                ...
                .enqueue(new Callback<PromoterVideoModel>() {
                    ...
                    public void onFailure(Call<PromoterVideoModel> call, Throwable t) {
                        ...
                        showToast(PromotorOrUserVideoPlaying.this, getResources().getString(R.string.internet_err));
                    }
                });
    }
