...
public class ViewLiveVideoViewScreen2 extends BaseActivity {
    ...
    private void initVideoView() {
        ...
        mVideoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                Toast.makeText(ViewLiveVideoViewScreen2.this, "Current Stream Stopped! ", Toast
                        .LENGTH_LONG).show();
                releasePlayer();
            }
        });
        ...
        mVideoView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mediaPlayer, int i, int i1) {
                dismissAppDialog();
                Toast.makeText(ViewLiveVideoViewScreen2.this, "Live stream might be ended!!! Kindly choose another camera! ", Toast
                        .LENGTH_LONG).show();
                return true;
            }
        });
    ...
    public void retrofitOnResponse(Object responseObj, final int responseType) {
        ...
        if (responseObj instanceof LiveStreamResponse) {
            ...
            if (mLiveStreamList.size() > 0) {
                ...
                showToast(ViewLiveVideoViewScreen2.this, "No streams are available");
                finish();
            }
    ...
    private void loadVideo(int currentPos) {
        ...
        String mStreamName = mLiveStreamList.get(mCurrentPos).getStreamName();
